...
public class Account implements Serializable {
	...
	public void setAccount_category(
	...
	public void setContact_state(
			String contact_state) {
		this.contact_state = contact_state;
	}

	public void setContact_zip(
			String contact_zip) {
	...
	public void setPackageList(
			Collection<Package> packageList) {
	...
	public String toString() {
		return "Account [accountCategory=" + accountCategory + ", accountNo=" + accountNo + ", activeDate=" + activeDate + ", balance=" + balance + ", contact_address1=" + contact_address1 + ", contact_address2=" + contact_address2 + ", contact_city=" + contact_city + ", contact_email=" + contact_email + ", contact_number=" + contact_number + ", contact_state=" + contact_state + ", contact_zip=" + contact_zip + ", firstName=" + firstName + ", inactiveDate=" + inactiveDate + ", lastName=" + lastName
				+ ", middleName=" + middleName + ", packageList=" + packageList + ", serviceInstanceList=" + serviceInstanceList + "]";
	}
