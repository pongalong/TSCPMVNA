...
public class BillingServerUtil {
	private static final Logger logger = LoggerFactory.getLogger(BillingServerUtil.class);

	public static ValueHolder checkResponse(
			ArrayOfValueHolder values) throws BillingServerException {
	...
	public static void checkResponse(
			MessageHolder message) throws BillingServerException {
	...
	public static void checkResponse(
			ArrayOfMessageHolder messages) throws BillingServerException {
