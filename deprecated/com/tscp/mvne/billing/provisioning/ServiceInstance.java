...
public class ServiceInstance implements Serializable {
	...
	public void setSubscriberNumber(
	...
	public String toString() {
		return "ServiceInstance [subscriberNumber=" + subscriberNumber + ", externalIdType=" + externalIdType + ", externalId=" + externalId + ", activeDate=" + activeDate + ", inactiveDate=" + inactiveDate + "]";
	}
