...
public class CustInfo implements Serializable {
	...
	public boolean equals(
		...
		if (obj instanceof CustInfo) {
			...
			return (custInfo.getCustId() == getCustId() && custInfo.getFirstName().equals(getFirstName()) && custInfo.getMiddleName().equals(getMiddleName()) && custInfo.getLastName().equals(getLastName()));
		} else {
