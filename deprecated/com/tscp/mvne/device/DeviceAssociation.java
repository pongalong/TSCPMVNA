...
public class DeviceAssociation implements Serializable {
	...
	public String toString() {
		return "DeviceAssociation [deviceId=" + deviceId + ", accountNo=" + accountNo + ", externalId=" + externalId + ", subscrNo=" + subscrNo + ", activeDate=" + activeDate + ", inactiveDate=" + inactiveDate + ", modDate=" + modDate + "]";
	}
