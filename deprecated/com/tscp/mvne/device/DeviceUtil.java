...
public class DeviceUtil {
  ...
  public static void checkDevice(OldDevice device) throws DeviceException {
    if (device.getId() == 0) {
  ...
  public static void checkOwnership(int custId, OldDevice device) throws DeviceException {
