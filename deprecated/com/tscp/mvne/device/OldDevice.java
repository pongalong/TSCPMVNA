...
@Deprecated
public class OldDevice implements Serializable {
	...
	public String toString() {
		return "Device [id=" + id + ", accountNo=" + accountNo + ", custId=" + custId + ", label=" + label + ", value=" + value + ", status=" + status + "]";
	}
