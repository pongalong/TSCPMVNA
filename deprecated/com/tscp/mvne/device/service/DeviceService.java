...
public class DeviceService {
  ...
  public List<OldDevice> getDevices(int custId, int accountNo) throws DeviceException {
    List<OldDevice> devices = system.getDevices(custId, 0, accountNo);
  ...
  public OldDevice getDevice(int custId, int deviceId, int accountNo) throws DeviceException {
    List<OldDevice> devices = system.getDevices(custId, deviceId, accountNo);
    if (devices == null || devices.isEmpty()) {
  ...
  public OldDevice getDevice(int custId, int accountNo) throws DeviceException {
    List<OldDevice> devices = system.getDevices(custId, 0, accountNo);
    if (devices == null || devices.isEmpty()) {
