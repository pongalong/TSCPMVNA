...
public class Dao {
	...
	protected static Collection<Session> openSessions = new HashSet<Session>();
	...
	private static void closeSession(
		...
		logger.trace("Session closed. Session count: {}", openSessions.size());
	}
	...
	protected static Session getSession() {
		try {
			...
			logger.trace("Session opened. Session count: {}", openSessions.size());
			return session;
