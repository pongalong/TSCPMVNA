...
public class RefundService {
	...
	public void applyChargeCredit(
			OldCreditCard creditCard, String amount) throws RefundException {
	...
	public synchronized int refundPayment(
			int accountNo, int transId, int trackingId, String amount, String refundBy, int refundCode, String notes) throws RefundException {
		return refundDao.refundPayment(accountNo, transId, trackingId, amount, refundBy, refundCode, notes);
	}

	// TODO unused method. check for removal.
	@Deprecated
	public Refund getRefundByTransId(
			int transId) {
